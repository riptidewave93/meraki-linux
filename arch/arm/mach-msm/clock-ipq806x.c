...
static struct clk_lookup msm_clocks_gsbi1_uart[] = {
...
struct clock_init_data ipq806x_gsbi1_uart_clks  __initdata = {
	.table = msm_clocks_gsbi1_uart,
	.size = ARRAY_SIZE(msm_clocks_gsbi1_uart),
};
...
static struct clk_lookup msm_clocks_ipq806x_dummy[] = {
	...
	*/
	...
	CLK_DUMMY("core_clk",		gsbi1_uart_clk.c, "msm_serial_hsl.0", 0),
