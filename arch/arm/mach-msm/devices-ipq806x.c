...
struct ramoops_platform_data msm_ramoops_pdata = {
       .mem_size = 0x40000,
       .record_size = 0x20000,
       .mem_address = 0x5ffc0000,
       .dump_oops = 1,
};
...
struct platform_device ramoops_device = {
	...
	.id		= -1,
	.dev = {
		.platform_data = &msm_ramoops_pdata,
	},
};
...
struct platform_device ipq806x_device_gpio_i2c_gsbi2 = {
	.name		= "i2c-gpio",
	.id		= 1,
};

struct platform_device ipq806x_device_meraki_config = {
    .name = "meraki-config",
    .id = -1,
};
...
static struct qca_85xx_sw_platform_data ap160_2_8511_sw_data = {
	...
	.trunk_cfg = {
		...
		.trunk_id = 0,
		.trunk_hash_policy = (TRUNK_L4_DST_PORT_INCL
						| TRUNK_L4_SRC_PORT_INCL
						| TRUNK_DST_IP_INCL
						| TRUNK_SRC_IP_INCL
						| TRUNK_L2_PROT_INCL
						| TRUNK_MAC_DA_INCL
...
static struct ar8327_platform_data ipq806x_ap160_ar8337_data = {
	.pad0_cfg = &ipq806x_ap160_ar8337_pad6_cfg,
	.pad5_cfg = &ipq806x_ap160_ar8337_pad6_cfg,
...
struct mtd_partition msm_nand_partition[] =   {
    { .name = "ubi", .offset = 0 , .size = 0x4000000 },
};

struct flash_platform_data msm_nand_data = {
	.version = VERSION_2,
    .nr_parts = 1,
    .parts = msm_nand_partition,
};
