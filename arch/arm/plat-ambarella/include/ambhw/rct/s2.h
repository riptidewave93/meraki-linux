 ...
 */
	 ...
	 */
#define SYS_CONFIG_NAND_INTERFACE	0x00000001 /* 0:3.3 V, 1: 1.8V */

						   /* Idsp  / Core  / DDR   */
#define SYS_CONFIG_CLOCK_CONFIG_0	0x00000000 /* 384  / 336  / 504  */
#define SYS_CONFIG_CLOCK_CONFIG_1	0x00000002 /* 240  / 240  / 336 */
#define SYS_CONFIG_CLOCK_CONFIG_2	0x00000004 /* 144  / 144  / 216 */
#define SYS_CONFIG_CLOCK_CONFIG_3	0x00000006 /* 348  / 360  / 552 */
#define SYS_CONFIG_CLOCK_CONFIG_4	0x00000008 /* 384  / 336  / 504 */
#define SYS_CONFIG_CLOCK_CONFIG_5	0x0000000a /* 240  / 240  / 336  */
#define SYS_CONFIG_CLOCK_CONFIG_6	0x0000000c /* 144  / 144  / 216  */
#define SYS_CONFIG_CLOCK_CONFIG_7	0x0000000e /* 348  / 360  / 552  */

#define SYS_CONFIG_NAND_FLASH_PAGE	0x00000010 /* 0: 512Byte, 1: 2K Byte */
/* bit4 - 0:2 bytes ,1: 3 bytes ,For BOOT ROM Mode */
#define SYS_CONFIG_SPI_EEPROM_ADDR	0x00000010
#define SYS_CONFIG_NAND_READ_CONFIRM	0x00000020 /* 0: not use, 1: use */

#define SYS_CONFIG_BOOT_BYPASS		0x00000040
#define SYS_CONFIG_FAST_BOOT		0x00000080

#define SYS_CONFIG_NAND_ECC_BCH_EN	0x00000400 /*0:  disable, 1: enable */
/* NAND Spare Area 2x, 0: disable, 1: enable */
#define SYS_CONFIG_NAND_ECC_SPARE_2X	0x00000800

	/*
	 * POC[8,12]
	 * 0x0 : Boot with USB (ARM code on internal ROM).
	 * 0x1 : Boot ROM via SSI0 +SD/MMC/SDXC
	 * 0x2 : Flash Boot
	 */
#define SYS_CONFIG_USB_BOOT		0x00000000
#define SYS_CONFIG_FLASH_BOOT		0x00000100
#define SYS_CONFIG_SD_BOOT		0x00001000 /* BOOT ROM via SSI0 + SD */
#define SYS_CONFIG_EMMC_SD_BOOT		0x00002000 /* 0:  disable, 1: enable */
#define SYS_CONFIG_USB_CLK_12M		0x00004000

/* 0:  Normal speed(25Mhz), 1: High speed(up to 50Mhz) */
#define SYS_CONFIG_EMMC_SD_HS		0x00010000
/* 0:  Single SDR mode, 1: Double DDR mode */
#define SYS_CONFIG_EMMC_SD_DDR		0x00020000
/* eMMC 4 bit Bus Width - 0:  disable, 1: enable */
#define SYS_CONFIG_EMMC_SD_4BIT		0x00040000
/* eMMC 8 bit Bus Width - 0:  disable, 1: enable */
#define SYS_CONFIG_EMMC_SD_8BIT		0x00080000

#define SYS_CONFIG_USB_INTERFACE	0x00200000 /* 0: USB device, 1: USB host*/
#define SYS_CONFIG_ENET_SEL		0x00800000 /* 0: disable, 1: enable */

/* 0: Normal source, 1: Reference Clock */
#define SYS_CONFIG_VSYNC_CLK_SRC	0x20000000
#define SYS_CONFIG_HSYNC_CLK_SRC	0x40000000
/* 0: set on pins, 1: set on eFUSE ROM (expect POC[8,12]) */
#define SYS_CONFIG_SET_EFUSE_ROM	0x80000000
