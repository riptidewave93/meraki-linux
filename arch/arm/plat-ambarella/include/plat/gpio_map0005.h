...
#ifndef __GPIO_MAP0005_H__
#define __GPIO_MAP0005_H__
...
#define	GPIO_PIN_IDX_OUTPUT_POWER_GREEN_LED			(-1)
#define	GPIO_PIN_IDX_OUTPUT_POWER_AMBER_LED			(-1)
#define	GPIO_PIN_IDX_OUTPUT_NETWORK_GREEN_LED		(49)
#define	GPIO_PIN_IDX_OUTPUT_NETWORK_AMBER_LED		(46)
