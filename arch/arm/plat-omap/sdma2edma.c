...
{
	printk(KERN_INFO "omap_set_dma_src_burst_mode: un-supported"
				" SDMA wrapper\n");
}
...
{
	printk(KERN_INFO "omap_set_dma_dest_burst_mode: un-supported"
				" SDMA wrapper\n");
}
...
{
	printk(KERN_INFO "omap_get_dma_dst_pos: un-supported"
				" in SDMA wrapper\n");
	return 0;
}
...
{
	printk(KERN_INFO "omap_get_dma_active_status: un-supported"
				" in SDMA wrapper\n");
	return 0;
}
