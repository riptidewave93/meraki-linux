...
#define ATH_DDR_PLL_DITHER		ATH_PLL_BASE+0x44
#define ATH_CPU_PLL_DITHER		ATH_PLL_BASE+0x48
...
#define AR934X_CPU_PLL_DITHER                   (ATH_PLL_BASE + 0x0048)
#define AR934X_DDR_PLL_DITHER                   (ATH_PLL_BASE + 0x0044)
#define AR934X_BB_PLL_CONFIG                    (ATH_PLL_BASE + 0x0040)
#define AR934X_CURRENT_AUDIO_PLL_MODULATION     (ATH_PLL_BASE + 0x003c)
#define AR934X_AUDIO_PLL_MOD_STEP               (ATH_PLL_BASE + 0x0038)
#define AR934X_AUDIO_PLL_MODULATION             (ATH_PLL_BASE + 0x0034)
#define AR934X_AUDIO_PLL_CONFIG                 (ATH_PLL_BASE + 0x0030)
#define AR934X_ETH_XMII                         (ATH_PLL_BASE + 0x002c)
#define AR934X_CURRENT_PCIE_PLL_DITHER          (ATH_PLL_BASE + 0x0028)
#define AR934X_SWITCH_CLOCK_SPARE               (ATH_PLL_BASE + 0x0024)
#define AR934X_LDO_POWER_CONTROL                (ATH_PLL_BASE + 0x0020)
#define AR934X_PCIE_PLL_DITHER_STEP             (ATH_PLL_BASE + 0x001c)
#define AR934X_PCIE_PLL_DITHER_DIV_MIN          (ATH_PLL_BASE + 0x0018)
#define AR934X_PCIE_PLL_DITHER_DIV_MAX          (ATH_PLL_BASE + 0x0014)
#define AR934X_PCIE_PLL_CONFIG                  (ATH_PLL_BASE + 0x0010)
#define AR934X_CPU_SYNC                         (ATH_PLL_BASE + 0x000c)
#define AR934X_CPU_DDR_CLOCK_CONTROL            (ATH_PLL_BASE + 0x0008)
#define AR934X_DDR_PLL_CONFIG                   (ATH_PLL_BASE + 0x0004)
#define AR934X_CPU_PLL_CONFIG                   (ATH_PLL_BASE + 0x0000)
