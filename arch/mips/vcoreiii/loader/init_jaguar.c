...
init_gpio(void)
{
	/* Place PHY in reset (low), turn amber LED on (high),
           unselect slave chip (if any) (high) */
	VTSS_DEVCPU_GCB_GPIO_GPIO_OUT = VTSS_BIT(21) | VTSS_BIT(23);
	VTSS_DEVCPU_GCB_GPIO_GPIO_OE = (VTSS_BIT(12) | VTSS_BIT(21) |
					VTSS_BIT(23));
