...
#define PPC44x_TLB_FAR		0x00200000	/* Fixed address region */
#define PPC44x_TLB_WL1		0x00100000	/* Write through L1 */
#define PPC44x_TLB_IL1I		0x00080000	/* L1 instr cache inhibit */
#define PPC44x_TLB_IL1D		0x00040000	/* L1 data cache inhibit */
#define PPC44x_TLB_IL2I		0x00020000	/* L2 instr cache inhibit */
#define PPC44x_TLB_IL2D		0x00010000	/* L2 data cache inhibit */
...
extern unsigned int tlb_44x_hwater[NR_CPUS];
extern unsigned int tlb_44x_index[NR_CPUS];
