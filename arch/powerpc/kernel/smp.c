...
/*
 * Default secondary_cpu_l2c_init
 */
void __attribute__ ((weak)) secondary_cpu_l2c_init(void)
{
	/* Generic secondary_cpu_l2c_init, implement your own */
	return;
}
