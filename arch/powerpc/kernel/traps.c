...
/*
 * Default machine_check_4xx_custom
 */
void __attribute__ ((weak)) machine_check_4xx_custom(void)
{
	/* Generic machine_check for L2 cache, bridges, and other specifics
	   to an SoC.
	 */
	return;
}
...
void __attribute__ ((weak)) WatchdogHandler(struct pt_regs *regs)
{
	...
	die("Unhandled watchdog timeout", regs, SIGABRT);
	return;
}
