...
#define LP5521_R_EXEC_RUN		0x20	/* Set Red channel to "Run" State */
#define LP5521_G_EXEC_RUN		0x08	/* Set Green channel to "Run" State */
#define LP5521_B_EXEC_RUN		0x02	/* Set Blue channel to "Run" State */
#define LP5521_EXEC_RUN			(LP5521_R_EXEC_RUN | LP5521_G_EXEC_RUN | LP5521_B_EXEC_RUN)
#define LP5521_ENABLE_DEFAULT	\
	(LP5521_MASTER_ENABLE | LP5521_LOGARITHMIC_PWM)
#define LP5521_ENABLE_RUN_PROGRAM	\
	(LP5521_ENABLE_DEFAULT | LP5521_EXEC_RUN)

/* Enable Register fields masks */
#define LP5521_LOGARITHMIC_PWM_MASK	0x80
#define LP5521_MASTER_ENABLE_MASK	0x40
#define LP5521_R_EXEC_MASK		0x30
#define LP5521_G_EXEC_MASK		0x0C
#define LP5521_B_EXEC_MASK		0x03
#define LP5521_EXEC_MASK		(LP5521_R_EXEC_MASK | LP5521_G_EXEC_MASK | LP5521_B_EXEC_MASK)
...
/* Config Register fields masks */
#define LP5521_PWM_HF_MASK		0x40
#define LP5521_PWRSAVE_EN_MASK		0x20
#define LP5521_CP_MODE_MASK		0x18
#define LP5521_R_TO_BATT_MASK		0x04
#define LP5521_CLK_DET_EN_MASK		0x02
#define LP5521_INT_CLK_EN_MASK		0x01
...
static int lp5521_post_init_device(struct lp55xx_chip *chip)
{
	...
	/* Setting up configuration register */
	val = LP5521_DEFAULT_CFG;
	if (!lp55xx_is_extclk_used(chip))
		val |= LP5521_CLK_INT;
	if (pdata->cp_mode_exists)
		val = ((val & (~LP5521_CP_MODE_MASK)) | (pdata->cp_mode << 3));
	if (pdata->pwrsave_dis)
		val &= (~LP5521_PWRSAVE_EN_MASK);
	...
	val = LP5521_ENABLE_RUN_PROGRAM;
	if(pdata->log_pwm_dis) {
		val &= (~LP5521_LOGARITHMIC_PWM_MASK);
	}
	if(pdata->exec_exists) {
		val = ((val & (~LP5521_EXEC_MASK)) | pdata->exec | (pdata->exec << 2) | (pdata->exec << 4));
	}
	/* Each channel (R, G or B) engine operates in tandem with OP_MODE register settings */
