...
static struct led_nu801_data* leds_nu801_create_of(struct platform_device *pdev)
{
...
MODULE_DEVICE_TABLE(of, of_numen_leds_match);
...
module_platform_driver(led_nu801_driver);
