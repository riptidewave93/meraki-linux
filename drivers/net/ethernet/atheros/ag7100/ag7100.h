...
enum AG7100_MII_TYPE { AG7100_MII_GMII, AG7100_MII_MII, AG7100_MII_RGMII,
		       AG7100_MII_RMII};

#if defined (CONFIG_AG7100_GE0_GMII)
    #define     AG7100_MII0_INTERFACE   AG7100_MII_GMII
#elif defined (CONFIG_AG7100_GE0_MII)
    #define     AG7100_MII0_INTERFACE   AG7100_MII_MII
#elif defined (CONFIG_AG7100_GE0_RGMII)
    #define     AG7100_MII0_INTERFACE   AG7100_MII_RGMII
#elif defined (CONFIG_AG7100_GE0_RMII)
    #define     AG7100_MII0_INTERFACE   AG7100_MII_RMII
...
#else
#define mii_reg(_mac)   (AR7100_MII1_CTRL + ((_mac)->mac_unit * 4))
#endif
...
/*
 * To make IP headers be 4 byte aligned, we would like to receive
 * packets at %4=2 alignement, however, the RX DMA needs 4 byte
 * alignment, so it is not possible to have IP packets be 4 byte
 * aligned.
 */
...
#define AG7100_RX_BUF_ALLOC_SIZE (AG7100_RX_RESERVE + AG7100_RX_BUF_SIZE)
...
#define AG7100_MAC_CFG1_TX_SYNC        (1 << 1)
#define AG7100_MAC_CFG1_RX_SYNC        (1 << 3)
...
static inline int ag7100_ring_incr(ag7100_ring_t *r, int val)
{
    val++;
