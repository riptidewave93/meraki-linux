...
#define AR7100_I2C_SCL  (1<<1)
#define AR7100_I2C_SDA  (1<<2)
#define AR7100_I2C_PAUSE 2

/* allow GPIO0/GPIO1 to be used as SCL/SDA for software based i2c */
void ar7100_gpio_enable_i2c_on_gpio_1_2(void);
...
#define AR7100_CHIP_REV_MAJOR_AR7100 (0xa0)
#define AR7100_CHIP_REV_MAJOR_AR7240 (0xc0)
#define AR7100_CHIP_REV_MAJOR_M_AR72XX  (0x0ff0)
#define AR7100_CHIP_REV_MAJOR_AR724X (0x0100)
/*
