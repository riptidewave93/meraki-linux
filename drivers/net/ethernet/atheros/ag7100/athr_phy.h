...
/* ATHR_PHY_ID1 and ATHR_PHY_ID2 registers */

#define ATHR_PHY_ID1_EXPECTATION	0x004d
#define ATHR_PHY_ID2_EXPECTATION	0xd04e
...
unsigned int athr_phy_get_link_status(int unit, int *link, int *fdx, ag7100_phy_speed_t *speed);
extern struct ag7100_phy_disp_t athr_phy_disp;
#endif /* _ATHR_PHY_H */
