...
#define ATHR26_ADVERTISE_ALL (ATHR_ADVERTISE_ASYM_PAUSE | ATHR_ADVERTISE_PAUSE | \
...
unsigned int agthrs26_get_link_status(int unit, int *link, int *fdx, ag7100_phy_speed_t *speed);
int athrs26_phy_do_ioctl(struct net_device *dev, struct ifreq *ifr, int cmd);
extern struct ag7100_phy_disp_t athrs26_phy_disp;
#endif
