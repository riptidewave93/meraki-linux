...
#define IP_SPECIFIC_CONTROL_STATUS		0x10//Eliot++ Register_16
...
#define IP_ADVERTISE_PAUSE                 0x0400 //Eliot add
...
int ip_phySetup(int ethUnit);
int ip_phyIsUp(int ethUnit);
int ip_phyIsFullDuplex(int ethUnit);
int ip_phySpeed(int ethUnit);
unsigned int ip_phyGetLinkStatus(int, int *, int *, ag7100_phy_speed_t *);
extern struct ag7100_phy_disp_t ip_phy_disp;
