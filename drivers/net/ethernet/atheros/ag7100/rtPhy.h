...
BOOL rt_phySetup(int ethUnit);
int rt_phyIsFullDuplex(int ethUnit);
BOOL rt_phySpeed(int phyUnit);
int rt_phyIsUp(int ethUnit);
unsigned int rt_phyGetLinkStatus(int unit, int *link, int *fdx, ag7100_phy_speed_t *speed);
extern struct ag7100_phy_disp_t rt_phy_disp;
