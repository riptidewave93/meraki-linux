...
static int ar8327_init(struct mii_phy *phy)
{
	return 0;
}

static int ar8327_poll_link(struct mii_phy *phy)
{
	return 1;
}

static int ar8327_read_link(struct mii_phy *phy)
{
	phy->speed= SPEED_1000;
	phy->duplex = DUPLEX_FULL;
	return 0;
...
static int ar8327_setup_aneg(struct mii_phy *phy, u32 advertise)
{
        (void)phy;
        (void)advertise;
        return 0;
...
static int ar8327_setup_forced(struct mii_phy *phy, int speed, int fd)
{
        (void)phy;
        (void)speed;
        (void)fd;
...
static struct mii_phy_ops ar8327_phy_ops = {
	.init		= ar8327_init,
	.setup_aneg	= ar8327_setup_aneg,
	.setup_forced	= ar8327_setup_forced,
	.poll_link	= ar8327_poll_link,
	.read_link	= ar8327_read_link,
};

static struct mii_phy_def ar8327_phy_def = {
	.phy_id		= 0x004dd030,
	.phy_id_mask	= 0xfffffff8,
	.name		= "Atheros 8327 Ethernet Switch",
	.ops		= &ar8327_phy_ops,
};
...
static struct mii_phy_def ar8035_phy_def = {
	...
	.name		= "Atheros 8305 Gigabit Ethernet",
	.ops		= &ar8035_phy_ops,
};
