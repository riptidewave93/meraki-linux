...
#define IGB_RX_WTHRESH                     ((hw->mac.type == e1000_igb_82576 && \
                                             adapter->msix_entries) ? 1 : 4)
#define IGB_TX_WTHRESH                     ((hw->mac.type == e1000_igb_82576 && \
...
#define IGB_MASTER_SLAVE	e1000_igb_ms_hw_default
#endif
...
struct igb_tx_buffer {
	union e1000_igb_adv_tx_desc *next_to_watch;
...
#define IGB_RX_DESC(R, i)	    \
	(&(((union e1000_igb_adv_rx_desc *)((R)->desc))[i]))
#define IGB_TX_DESC(R, i)	    \
	(&(((union e1000_igb_adv_tx_desc *)((R)->desc))[i]))
#define IGB_TX_CTXTDESC(R, i)	    \
	(&(((struct e1000_igb_adv_tx_context_desc *)((R)->desc))[i]))
...
static inline __le32 igb_test_staterr(union e1000_igb_adv_rx_desc *rx_desc,
...
struct igb_therm_proc_data
{
	...
	struct e1000_igb_thermal_diode_data *sensor_data;
};
...
struct igb_adapter {
	...
	/* structs defined in e1000_igb_hw.h */
	struct e1000_igb_hw hw;
	struct e1000_igb_hw_stats stats;
	struct e1000_igb_phy_info phy_info;
	struct e1000_igb_phy_stats phy_stats;
