...
void _kc_igb_netif_set_real_num_tx_queues(struct net_device *dev, unsigned int txq)
{
...
u32 _kc_igb_ethtool_op_get_flags(struct net_device *dev)
{
	return dev->features & _kc_flags_dup_features;
}

int _kc_igb_ethtool_op_set_flags(struct net_device *dev, u32 data, u32 supported)
{
	if (data & ~supported)
		return -EINVAL;
...
u16 ___kc_igb_skb_tx_hash(struct net_device *dev, const struct sk_buff *skb,
		      u16 num_tx_queues)
{
	u32 hash;
