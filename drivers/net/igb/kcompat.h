...
#define skb_tx_hash(n, s) ___kc_igb_skb_tx_hash((n), (s), (n)->real_num_tx_queues)
#ifdef IXGBE_FCOE
#undef CONFIG_FCOE
#undef CONFIG_FCOE_MODULE
#endif /* IXGBE_FCOE */
...
void _kc_igb_netif_set_real_num_tx_queues(struct net_device *, unsigned int);
#define netif_set_real_num_tx_queues  _kc_igb_netif_set_real_num_tx_queues
...
extern int _kc_igb_ethtool_op_set_flags(struct net_device *, u32, u32);
#define ethtool_op_set_flags _kc_igb_ethtool_op_set_flags
extern u32 _kc_igb_ethtool_op_get_flags(struct net_device *);
#define ethtool_op_get_flags _kc_igb_ethtool_op_get_flags
...
#endif
#endif /* CONFIG_DCB */
extern u16 ___kc_igb_skb_tx_hash(struct net_device *, const struct sk_buff *, u16);
#define __skb_tx_hash(n, s, q) ___kc_igb_skb_tx_hash((n), (s), (q))
#else /* < 2.6.38 */
#endif /* < 2.6.38 */
