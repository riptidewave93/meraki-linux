 ...
 * @cmd_ctrl:		[BOARDSPECIFIC] hardware specific function for
 *			controlling ALE/CLE/nCE. Also used to write command
 *			and address
 * @init_size:		[BOARDSPECIFIC] hardware specific function for setting
