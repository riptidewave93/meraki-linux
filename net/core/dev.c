...
/*
 * Click: Allow Click to set gso skb destructor.
 */
void
set_dev_gso_skb_destructor(struct sk_buff *skb)
{
    DEV_GSO_CB(skb)->destructor = skb->destructor;
    skb->destructor = dev_gso_skb_destructor;
}
EXPORT_SYMBOL(set_dev_gso_skb_destructor);

void
reset_dev_gso_skb_destructor(struct sk_buff *skb)
{
    skb->destructor = DEV_GSO_CB(skb)->destructor;
}
EXPORT_SYMBOL(reset_dev_gso_skb_destructor);
