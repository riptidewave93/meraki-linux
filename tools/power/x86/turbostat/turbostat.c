...
void check_permissions()
{
  ...
  /* @Meraki: this is a patch since we are not compiling in a new enough uclibc for euidaccess
   * We should not ship turbostat with any firmware. This is for performance debugging.
   * /
//	sprintf(pathname, "/dev/cpu/%d/msr", base_cpu);
